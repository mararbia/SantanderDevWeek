...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setSupportActionBar(findViewById(R.id.toolbar)) //Chamando a toolbar para que seja mostrado na tela)
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        val inflate = menuInflater //Inflando o layout para mostrar na tela
        inflate.inflate(R.menu.main_menu, menu)
        return true //Retorna true para que o menu sempre seja exibido
    }

    //Gerenciando os cliques do menu
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.item_1 -> {
                Log.d("CLICK", "Click no item 1") //Dispara Log no console. A Tag é um identificador do log
